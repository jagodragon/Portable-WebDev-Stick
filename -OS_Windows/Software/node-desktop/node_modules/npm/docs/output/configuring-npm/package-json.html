...
<p>Override values can use any specifier that npm accepts for dependencies, including
an exact version, a semver range, a dist-tag, or a replacement specifier such as
<code>npm:</code>, <code>file:</code>, or a Git URL.</p>
<p>For example, if you only need to enforce a minimum patched release instead of one
exact version, you can use a semver range:</p>
<pre><code class="language-json">{
  "overrides": {
    "@npm/foo": "^1.0.0"
  }
