...
<p>You may also specify a bare hostname (e.g., "registry.npmjs.org") to only
replace URLs coming from that host.</p>
<p>You may also specify a full URL including a path (e.g.,
"<a href="https://old-registry.example.com/npm/path">https://old-registry.example.com/npm/path</a>"). In that case, resolved URLs
