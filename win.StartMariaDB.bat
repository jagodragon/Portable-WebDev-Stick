...
start /b "MariaDB-Core" "OS_Windows\Software\mariadb\bin\mysqld.exe" --defaults-file="%USB_ROOT%\SharedSettings\mariadb-configs.cnf" --datadir="%USB_ROOT%\mariadb-data"
